...
def test_list_runs_filters_and_paginates(authenticated_client: TestClient) -> None:
    ...
    second_run = _create_run_record(site_id=first_site.site_id, status=RunStatus.SUBMITTED)
    third_run = _create_run_record(site_id=second_site.site_id, status=RunStatus.COMPLETED)
