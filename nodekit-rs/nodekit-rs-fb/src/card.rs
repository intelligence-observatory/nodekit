...
impl<'a> Asset<'a> {
    ...
    pub fn hash(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(Asset::VT_HASH, None)
        }
    }
    #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AssetBuilder<'a, 'b, A> {
    ...
    pub fn add_hash(&mut self, hash: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Asset::VT_HASH, hash);
    }
    #[inline]
...
impl<'a> Card<'a> {
    ...
    pub fn timer(&self) -> Option<Timer<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Timer>>(Card::VT_TIMER, None)
        }
    }
    #[inline]
    ...
    pub fn id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(Card::VT_ID, None)
        }
    }
    #[inline]
    #[allow(non_snake_case)]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CardBuilder<'a, 'b, A> {
    ...
    pub fn add_timer(&mut self, timer: flatbuffers::WIPOffset<Timer<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<Timer>>(Card::VT_TIMER, timer);
    }
    #[inline]
    ...
    pub fn add_id(&mut self, id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Card::VT_ID, id);
    }
    #[inline]
