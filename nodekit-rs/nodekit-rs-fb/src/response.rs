...
impl<'a> AudioFrame<'a> {
  ...
  pub fn buffer(&self) -> flatbuffers::Vector<'a, u8> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(AudioFrame::VT_BUFFER, None).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for AudioFrame<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("buffer", Self::VT_BUFFER, true)?
...
impl<'a> VisualFrame<'a> {
  ...
  pub fn buffer(&self) -> flatbuffers::Vector<'a, u8> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(VisualFrame::VT_BUFFER, None).unwrap()}
  }
  #[inline]
...
impl<'a> Response<'a> {
  ...
  pub fn sensor(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Response::VT_SENSOR, None)}
  }
  #[inline]
  pub fn finished(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Response::VT_FINISHED, Some(false)).unwrap()}
  }
  #[inline]
  pub fn version(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Response::VT_VERSION, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_sensor(&mut self, sensor: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Response::VT_SENSOR, sensor);
  }
  #[inline]
  pub fn add_finished(&mut self, finished: bool) {
    self.fbb_.push_slot::<bool>(Response::VT_FINISHED, finished, false);
  }
  #[inline]
  pub fn add_version(&mut self, version: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Response::VT_VERSION, version);
  }
  #[inline]
