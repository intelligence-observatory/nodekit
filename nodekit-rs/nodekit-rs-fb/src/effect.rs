...
impl<'a> HidePointerEffect<'a> {
  ...
  pub fn end_msec(&self) -> i32 {
    ...
    unsafe { self._tab.get::<i32>(HidePointerEffect::VT_END_MSEC, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> HidePointerEffectBuilder<'a, 'b, A> {
  ...
  pub fn add_end_msec(&mut self, end_msec: i32) {
    self.fbb_.push_slot::<i32>(HidePointerEffect::VT_END_MSEC, end_msec, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> HidePointerEffectBuilder<'a, 'b, A> {
...
impl<'a> Effect<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.effect_type { builder.add_effect_type(x); }
  ...
  pub fn effect_type_type(&self) -> EffectType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<EffectType>(Effect::VT_EFFECT_TYPE_TYPE, Some(EffectType::NONE)).unwrap()}
  }
  #[inline]
  pub fn effect_type(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Effect::VT_EFFECT_TYPE, None)}
  }
  #[inline]
  pub fn timer(&self) -> Option<Timer<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Timer>>(Effect::VT_TIMER, None)}
  }
  #[inline]
  pub fn id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Effect::VT_ID, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Effect<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<EffectType, _>("effect_type_type", Self::VT_EFFECT_TYPE_TYPE, "effect_type", Self::VT_EFFECT_TYPE, false, |key, v, pos| {
        match key {
          EffectType::HidePointerEffect => v.verify_union_variant::<flatbuffers::ForwardsUOffset<HidePointerEffect>>("EffectType::HidePointerEffect", pos),
          _ => Ok(()),
        }
     })?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EffectBuilder<'a, 'b, A> {
  ...
  pub fn add_effect_type_type(&mut self, effect_type_type: EffectType) {
    self.fbb_.push_slot::<EffectType>(Effect::VT_EFFECT_TYPE_TYPE, effect_type_type, EffectType::NONE);
  }
  #[inline]
  pub fn add_effect_type(&mut self, effect_type: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Effect::VT_EFFECT_TYPE, effect_type);
  }
  #[inline]
  pub fn add_timer(&mut self, timer: flatbuffers::WIPOffset<Timer<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Timer>>(Effect::VT_TIMER, timer);
  }
  #[inline]
  pub fn add_id(&mut self, id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Effect::VT_ID, id);
  }
  #[inline]
      ...
      match self.effect_type_type() {
        EffectType::HidePointerEffect => {
          if let Some(x) = self.effect_type_as_hide_pointer_effect() {
            ...
            ds.field("effect_type", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        _ => {
          let x: Option<()> = None;
