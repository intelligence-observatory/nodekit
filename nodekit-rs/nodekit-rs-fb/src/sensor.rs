...
pub const ENUM_VALUES_CLICK_SENSOR_MASK: [ClickSensorMask; 2] =
    [ClickSensorMask::Rectangle, ClickSensorMask::Ellipse];
...
impl ClickSensorMask {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::Rectangle, Self::Ellipse];
...
impl<'a> ClickSensor<'a> {
    ...
    pub fn mask(&self) -> ClickSensorMask {
        ...
        unsafe {
            self._tab
                .get::<ClickSensorMask>(ClickSensor::VT_MASK, Some(ClickSensorMask::Rectangle))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ClickSensorBuilder<'a, 'b, A> {
    ...
    pub fn add_mask(&mut self, mask: ClickSensorMask) {
        self.fbb_.push_slot::<ClickSensorMask>(
            ClickSensor::VT_MASK,
            mask,
...
impl<'a> KeySensor<'a> {
    ...
    pub fn key(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(KeySensor::VT_KEY, None)
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> KeySensorBuilder<'a, 'b, A> {
    ...
    pub fn add_key(&mut self, key: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(KeySensor::VT_KEY, key);
    }
    #[inline]
...
impl<'a> SubmitSensor<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.source_ids {
            builder.add_source_ids(x);
        }
        if let Some(x) = args.submitter_id {
            builder.add_submitter_id(x);
        }
        builder.finish()
    }
    ...
    pub fn submitter_id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(SubmitSensor::VT_SUBMITTER_ID, None)
        }
    }
    #[inline]
    pub fn source_ids(
        ...
        unsafe {
            ...
            >>(SubmitSensor::VT_SOURCE_IDS, None)
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "submitter_id",
                Self::VT_SUBMITTER_ID,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>,
            >>("source_ids", Self::VT_SOURCE_IDS, false)?
            .finish();
        Ok(())
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SubmitSensorBuilder<'a, 'b, A> {
    ...
    pub fn add_submitter_id(&mut self, submitter_id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            SubmitSensor::VT_SUBMITTER_ID,
            submitter_id,
        );
    }
    #[inline]
    pub fn add_source_ids(
        &mut self,
        source_ids: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<&'b str>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(SubmitSensor::VT_SOURCE_IDS, source_ids);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> SubmitSensorBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
        SubmitSensorBuilder {
            fbb_: _fbb,
            start_: start,
...
impl<'a> TemporallyBoundedSensor<'a> {
    ...
    pub fn sensor_type(&self) -> TemporallyBoundedSensorType {
        ...
        unsafe {
            self._tab
                .get::<TemporallyBoundedSensorType>(
                    TemporallyBoundedSensor::VT_SENSOR_TYPE,
                    Some(TemporallyBoundedSensorType::NONE),
                )
                .unwrap()
        }
    }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(
                    TemporallyBoundedSensor::VT_SENSOR,
                    None,
                )
        }
    }
    ...
    pub fn timer(&self) -> Option<Timer<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Timer>>(TemporallyBoundedSensor::VT_TIMER, None)
        }
    }
    #[inline]
...
impl flatbuffers::Verifiable for TemporallyBoundedSensor<'_> {
    ...
    fn run_verifier(
        ...
        use self::flatbuffers::Verifiable;
        v.visit_table(pos)?
            .visit_union::<TemporallyBoundedSensorType, _>(
                "sensor_type",
                Self::VT_SENSOR_TYPE,
                "sensor",
                Self::VT_SENSOR,
                false,
                |key, v, pos| match key {
                    TemporallyBoundedSensorType::ClickSensor => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<ClickSensor>>(
                            "TemporallyBoundedSensorType::ClickSensor",
                            pos,
                        ),
                    TemporallyBoundedSensorType::KeySensor => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<KeySensor>>(
                            "TemporallyBoundedSensorType::KeySensor",
                            pos,
                        ),
                    TemporallyBoundedSensorType::SubmitSensor => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<SubmitSensor>>(
                            "TemporallyBoundedSensorType::SubmitSensor",
                            pos,
                        ),
                    _ => Ok(()),
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TemporallyBoundedSensorBuilder<'a, 'b, A> {
    ...
    pub fn add_sensor_type(&mut self, sensor_type: TemporallyBoundedSensorType) {
        self.fbb_.push_slot::<TemporallyBoundedSensorType>(
            TemporallyBoundedSensor::VT_SENSOR_TYPE,
            sensor_type,
            TemporallyBoundedSensorType::NONE,
        );
    ...
    pub fn add_timer(&mut self, timer: flatbuffers::WIPOffset<Timer<'b>>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Timer>>(
            TemporallyBoundedSensor::VT_TIMER,
            timer,
        );
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> TemporallyBoundedSensorBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
...
impl<'a> TimeoutSensor<'a> {
    ...
    pub fn timeout_msec(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TimeoutSensor::VT_TIMEOUT_MSEC, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a> Default for TimeoutSensorArgs {
    #[inline]
    fn default() -> Self {
        TimeoutSensorArgs { timeout_msec: 0 }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TimeoutSensorBuilder<'a, 'b, A> {
    ...
    pub fn add_timeout_msec(&mut self, timeout_msec: i32) {
        self.fbb_
            .push_slot::<i32>(TimeoutSensor::VT_TIMEOUT_MSEC, timeout_msec, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> TimeoutSensorBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
...
impl<'a> Sensor<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.sensor_type {
            builder.add_sensor_type(x);
        }
    ...
    pub fn sensor_type_type(&self) -> SensorType {
        ...
        unsafe {
            self._tab
                .get::<SensorType>(Sensor::VT_SENSOR_TYPE_TYPE, Some(SensorType::NONE))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(Sensor::VT_ID, None)
        }
    }
    #[inline]
    #[allow(non_snake_case)]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SensorBuilder<'a, 'b, A> {
    ...
    pub fn add_sensor_type_type(&mut self, sensor_type_type: SensorType) {
        self.fbb_.push_slot::<SensorType>(
            Sensor::VT_SENSOR_TYPE_TYPE,
            sensor_type_type,
            SensorType::NONE,
        );
    }
    #[inline]
    pub fn add_sensor_type(
        &mut self,
        sensor_type: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Sensor::VT_SENSOR_TYPE, sensor_type);
    }
    #[inline]
    pub fn add_id(&mut self, id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Sensor::VT_ID, id);
    }
    #[inline]
