...
impl<'a> Graph<'a> {
  ...
  pub fn cards(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Card<'a>>>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Card>>>>(Graph::VT_CARDS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GraphBuilder<'a, 'b, A> {
  ...
  pub fn add_cards(&mut self, cards: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Card<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Graph::VT_CARDS, cards);
  }
  #[inline]
