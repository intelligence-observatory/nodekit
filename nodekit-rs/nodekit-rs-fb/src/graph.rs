...
impl<'a> Graph<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.nodekit_version {
            builder.add_nodekit_version(x);
        }
        if let Some(x) = args.transitions {
            builder.add_transitions(x);
        }
    ...
    pub fn start(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(Graph::VT_START, None)
        }
    }
    #[inline]
    ...
    pub fn transitions(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Transition<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Transition>>,
            >>(Graph::VT_TRANSITIONS, None)
        }
    }
    #[inline]
    pub fn nodekit_version(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(Graph::VT_NODEKIT_VERSION, None)
        }
    }
}
...
impl flatbuffers::Verifiable for Graph<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Transition>>,
            >>("transitions", Self::VT_TRANSITIONS, false)?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "nodekit_version",
                Self::VT_NODEKIT_VERSION,
                false,
            )?
            .finish();
        Ok(())
...
pub struct GraphArgs<'a> {
    ...
    pub transitions: Option<
        flatbuffers::WIPOffset<
            flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Transition<'a>>>,
        >,
    >,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GraphBuilder<'a, 'b, A> {
    ...
    pub fn add_start(&mut self, start: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Graph::VT_START, start);
    }
    #[inline]
    pub fn add_nodes(
        &mut self,
    ...
    pub fn add_transitions(
        &mut self,
        transitions: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Transition<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Graph::VT_TRANSITIONS, transitions);
    }
    #[inline]
    pub fn add_nodekit_version(&mut self, nodekit_version: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            Graph::VT_NODEKIT_VERSION,
            nodekit_version,
        );
    }
    #[inline]
