...
impl<'a> Graph<'a> {
  ...
  pub fn payload(&self) -> flatbuffers::Vector<'a, u8> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Graph::VT_PAYLOAD, None).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GraphBuilder<'a, 'b, A> {
  ...
  pub fn add_payload(&mut self, payload: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Graph::VT_PAYLOAD, payload);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<Graph<'a>> {
    ...
    self.fbb_.required(o, Graph::VT_PAYLOAD,"payload");
