...
impl<'a> Graph<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.node_graph {
            builder.add_node_graph(x);
        }
        builder.finish()
    }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GraphBuilder<'a, 'b, A> {
    #[inline]
    pub fn add_node_graph(
        &mut self,
        node_graph: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Graph::VT_NODE_GRAPH, node_graph);
    }
    #[inline]
