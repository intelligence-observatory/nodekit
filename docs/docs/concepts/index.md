...
The NodeKit Board is 1024 x 768 _reference pixels_. A 1024 x 768 region corresponds to ~21.81° x 16.26° of the Agent's visual field, given the assumptions above, and when viewed straight on.
